...
let ws_url : Exchange.t -> Uri.t = function
  ...
  | Bybit | Bybit_spot | Bybit_inverse | Hyperliquid | Hyperliquid_spot | Bitget | Coinbase | Kraken ->    failwith "Binance_ws.ws_url: not a binance variant"
;;
...
let streams_for : Exchange.t -> string list = function
  ...
  | Bybit | Bybit_spot | Bybit_inverse | Hyperliquid | Hyperliquid_spot | Bitget | Coinbase | Kraken ->    failwith "Binance_ws.streams_for: not a binance variant"
;;
